...
export function createViewController({ state, controls, elements, viewLabels, actions }) {
  const { viewButtons, viewReadout } = elements;
  const allowedModes = new Set(Object.keys(viewLabels));

  function setViewMode(mode) {
    state.viewMode = allowedModes.has(mode) ? mode : "flat";
