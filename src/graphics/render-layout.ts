import type { ViewMode } from "../app/types.js";
...
export type CssLayout = RenderLayout & {
  flatPane?: Rect;
  domePane?: Rect;
};

export function getRenderLayout(width: number, height: number, options: RenderLayoutOptions): RenderLayout {
...
export function getCssLayout(width: number, height: number, options: RenderLayoutOptions): CssLayout {
  const fullRect = { x: 0, y: 0, width, height };
...
export function reviewSafeLeft(width: number, options: RenderLayoutOptions): number {
...
export function containRect(rect: Rect, aspect: number, padding: number): Rect {
...
function sourceAspect(options: RenderLayoutOptions): number {
